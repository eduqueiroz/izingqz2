  ...
  <div class="WAL position-relative bg-grey-3" :style="style">
    <q-layout class="WAL__layout shadow-3" container view="lHr LpR lFr">
      ...
      <q-toolbar class="q-pr-none q-gutter-xs full-width" style="height: 64px">
          ...
          <q-space />
          <q-btn flat class="bg-padrao btn-rounded" icon="mdi-forum-outline" @click="() => $router.push({ name: 'chat-privado' })" data-route="chat-privado" :disable="loadingMount">
          ...
          <q-btn style="margin-right: 5px;" flat class="bg-padrao btn-rounded" icon="mdi-home" @click="() => $router.push({ name: 'home-dashboard' })" data-route="home-dashboard" :disable="loadingMount">
        ...
        <q-toolbar v-show="toolbarSearch" class="row q-gutter-sm q-py-sm items-center">
                ...
                <div class="q-ma-sm">
                  ...
                  <div v-if="!pesquisaTickets.showAll ">
                    ...
                    <q-banner style="margin-top: 10px" class="bg-yellow text-black" inline-actions>
                      <span style="font-size: 12px !important;">Após aplicar o filtro BETA você deve clicar no botão Carregar Mais Atendimentos acima.</span>
                    </q-banner>
                    <q-select
          ...
          <q-btn flat class="bg-padrao btn-rounded" icon="mdi-book-account-outline" @click="$q.screen.lt.md ? (modalNovoTicket = true) : $router.push({ name: 'chat-contatos' })" data-route="chat-contatos" style="flex: 1;">
        ...
        <q-scroll-area style="height: calc(100vh - 70px)">
          <div class="q-pa-sm">
            ...
            <q-card class="bg-white btn-rounded q-mt-sm" style="width: 100%" bordered flat>
              <q-card-section class="text-center blur-effect">
                ...
                <div class="contact-info">
                  <div class="contact-details">
                    <div class="contact-item">
                      ...
                      <span class="contact-value blur-effect">{{ ticketFocado.contact.name || '' }}</span>
                    </div>
                    <div class="contact-item">
                      <span class="contact-label">Telefone:</span>
                      <span class="contact-value blur-effect">
    ...
    async sendProtocol (ticketFocado) {
      this.$q.dialog({
        ...
        if (data) {
          ...
          this.loading = true
          if(ticketFocado.channel !== 'waba' && ticketFocado.channel !== 'meow' && !ticketFocado.channel.includes('hub')){
            await EnviarMensagemTexto(ticketId, message)
          }
          if(ticketFocado.channel === 'waba' && ticketFocado.channel !== 'meow' && !ticketFocado.channel.includes('hub')){
            await EnviarTextoWaba(messageWaba)
          } 
          if(ticketFocado.channel === 'meow' ){
