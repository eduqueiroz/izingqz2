            ...
            <div class="login-content">
              ...
              <div class="text-primary">
                ...
                <div>
                  ...
                  <q-separator spaced />
                  <div class="text-primary q-mb-md" style="margin-top: 30px;">
                    <div style="font-size: 14px;">Arraste o slider até o final para liberar o seu login:</div>
                    <q-slider
...
export default {
  ...
  methods: {
    ...
    fazerLogin () {
      if (!this.isHuman) {
        this.$q.notify({
          message: "Por favor, valide o CAPTCHA antes de continuar.",
          color: "negative",
        });
        return;
      }
