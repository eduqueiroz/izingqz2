      ...
      <template v-for="item in canais">
        ...
        >
          ...
          >
            <template v-if="item.type !== 'messenger'">
              <q-btn
                v-if="(item.type == 'whatsapp' || item.type == 'baileys' || item.type == 'meow') && item.status == 'qrcode'"
                color="primary"
                label="QR Code"
              ...
              >
                ...
                />
                <q-btn
                  v-if="(item.type != 'whatsapp' && item.type != 'baileys' && item.type != 'meow')"
                  color="positive"
                  label="Conectar"
                  @click="handleStartWhatsAppSession(item.id)"
                />
                <q-btn
                  v-if="(item.status == 'DISCONNECTED' && item.type == 'whatsapp') || (item.status == 'DISCONNECTED' && item.type == 'baileys') || (item.status == 'DISCONNECTED' && item.type == 'meow')"
                  color="primary"
                  label="Novo QR Code"
