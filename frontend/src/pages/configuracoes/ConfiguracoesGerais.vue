<template>
  <div v-if="userProfile === 'admin'">
    <q-list class="text-weight-medium">
      ...
      <q-item tag="label" v-ripple>
        <q-item-section>
          <q-item-label>Usar Envio Rápido de Mensagens</q-item-label>
      ...
      <q-item tag="label" v-ripple>
        <q-item-section>
          <q-item-label>Transbordo de Mensagens</q-item-label>
          <q-item-label caption> Habilitando esta opção, o sistema irá fazer o transbordo do atendimento carteirizado, caso o usuário encontre-se com status offline. </q-item-label>
        </q-item-section>
...
import { ListarTenantPorId, AlterarTenantShowChatbot, AlterarTenantNullTickets, AlterarTenantTentativas, AlterarTenantLimiteTickets, AlterarTenantAgruparTicket, AlterarServicoTransbordo, AlterarTenantAtualizarNomes, AlterarTenantForcarPendente, AlterarTenantSemRedis, AlterarTenantFixarConexoes, AlterarTenantForcarAdmin } from 'src/service/tenants'
