        ...
        <q-list class="text-weight-medium">
          ...
          <div class="row q-px-md">
            ...
            <div class="col-12 q-py-md" v-if="useKanban">
              <div v-if="loadingKanban">Aguarde, carregando todos os contatos do sistema...</div>
            ...
            <div class="row q-px-md" v-if="whatsappId?.type !== 'baileys' && whatsappId?.type !== 'meow'" >
            ...
            <div v-if="whatsappId?.type !== 'baileys' && whatsappId?.type !== 'meow'" class="row q-px-md">
              <div class="col-12 q-py-md" style="margin: 1px;">
                <q-toggle
                  v-model="voice"
            ...
            <div v-if="voice && whatsappId?.type !== 'baileys' && whatsappId?.type !== 'meow'" class="col-12 q-py-md">
